...
def process_article(article):
    name = article[0]
    list_filter = ['Google_Traduction', 'Cookie_(informatique)', 'Wikipédia:', 'Wikip?dia:', 'Special:', 'Spécial:', 'Sp?cial:', 'Fichier:', 'Utilisateur:', 'Portail:', 'Aide:', 'Discussion:', 'Discussion_utilisateur:', 'Sujet:']
